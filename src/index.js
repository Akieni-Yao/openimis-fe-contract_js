...
} from "./components/ContractDetailsTab";
import {
...
} from "./components/ContractPaymentsTab";
import {
  ContractInsureePolicyTabLabel,
  ContractInsureePolicyTabPanel,
} from "./components/ContractInsureePolicyTab";
...
const DEFAULT_CONFIG = {
  ...
  refs: [
    ...
    {
      key: "contract.ContractPicker.projection",
      ref: CONTRACT_PICKER_PROJECTION,
    },
